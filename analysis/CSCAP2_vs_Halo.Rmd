...
plot_volcano_2(dep, contrast=test, add_names=T, label_size=5, adjusted = F, unique_vec = "SKAP2")
```
...
Now I perfom a gene onology analysis (GO or by branch GO:MF, GO:BP, GO:CC) and a REAC ontology.  
...
if(is.null(GO)){
  ...
  GO$result %>% 
    ...
    pageLength = 10)) %>%
    formatStyle('source', backgroundColor = styleEqual(c("GO:BP", "GO:MF", "GO:CC", "REAC"), c('orange', 'tomato', 'lightgreen', '#6e05e6')))
}
```
